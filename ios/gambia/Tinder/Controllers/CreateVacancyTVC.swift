   ...
   @objc func positionFieldDidChange(_ textField: UITextField) {
    ...
    func updateUI(){
        ...
        if let vacancy = self.vacancy{
            ...
            if language == "en" {
                scheduleLabel.text = Constants.SHEDULE_NAMES_EN[vacancy.scheduleId]
            } else if language == "ky" {
                scheduleLabel.text = Constants.SHEDULE_NAMES_KG[vacancy.scheduleId]
            } else {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.text = self.vacancy == nil ? "new_vacancy".localized() :"edit_vacancy".localized()
