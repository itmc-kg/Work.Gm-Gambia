...
class SelectVacancySheduleTVC: UITableViewController {
    ...
    @IBOutlet weak var grantsLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        volunteeringLabel.text = "volunteeringLabel".localized()
        grantsLabel.text = "grantsLabel".localized()
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        switch section {
        case 0:
            label.text = "employment".localized()
        case 1:
            label.text = "grafic".localized()
        default:
            break
        }
