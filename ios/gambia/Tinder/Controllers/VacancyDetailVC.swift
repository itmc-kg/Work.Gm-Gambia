...
class VacancyDetailVC: UIViewController {
    ...
    @IBOutlet weak var dissmisLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        dissmisLabel.text = "dissmisLabel".localized()
        navigationItem.title = "vacancy".localized()
