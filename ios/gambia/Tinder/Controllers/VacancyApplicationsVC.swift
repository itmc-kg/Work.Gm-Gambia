    ...
    private var undoApplication: Application?{
        didSet{
            if let application = undoApplication, let employee = application.employee {
                undoButton.sd_setImage(with: employee.getImageUrl(), for: .normal, placeholderImage: Constants.placeholder, options: .continueInBackground, completed: nil)
...
extension VacancyApplicationsVC: KolodaViewDelegate {
    ...
    func kolodaDidRunOutOfCards(_ koloda: KolodaView) {
        ...
        kolodaView.reloadData()
        lastApplicationDocument == nil ? reGetApplication() : getNextPageApplication()
    }
    
    func reGetApplication(){
...
extension VacancyApplicationsVC : EmployeeKolodaViewDelegate{
    ...
    func didSelectReject(application: Application, view: EmployeeKolodaView) {
        ...
        let alert = UIAlertController(title: "cancel_application".localized(), message: "", preferredStyle: UIAlertControllerStyle.alert)
