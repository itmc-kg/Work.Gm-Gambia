...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UserDefaults.standard.setValue(UsedCountry.Kyrgyzstan.rawValue,
                                       forKey: Constants.USED_COUNTRY)
    ...
    func setupAppLanguage() {
        let lan = UserDefaults.standard
            .string(forKey: Constants.applicationCurrentLanguage) ?? Language.ru.rawValue
