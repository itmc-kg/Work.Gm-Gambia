...
class ApplicationsTVC: UITableViewController {
            ...
            for application in applications{
                ...
                if let section = self.groups.index(where: {$0 == group}){
                    ...
                    self.groups.sort { (group1, group2) -> Bool in
                        return group1.date.compare(group2.date) == .orderedDescending
                    }
                }
            }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        showProfileButton.setTitle("showProfileButton".localized(), for: .normal)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.vacancy = groups[indexPath.section - 1].applications[indexPath.row].vacancy
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        case 0:
            ...
            label.text = "applications".localized()
...
extension ApplicationsTVC : ApplicationCellDelegate{
    func showMenu(application: Application) {
        ...
        alert.addAction(UIAlertAction(title: "delete".localized(), style: .destructive, handler: { aciton in
