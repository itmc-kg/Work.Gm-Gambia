...
class CreateCompanyTVC: UITableViewController {
    ...
    let aboutCompanyPlaceholder = "about_company".localized()
    ...
    private var employer : Employer?{
        didSet{
            ...
            companyLogoImageView.sd_setImage(with: employer.getImageUrl(), placeholderImage: Constants.placeholder, options: .continueInBackground) { (image, error, cache, url) in
                if error == nil{
    ...
    override func viewDidLoad() {
        ...
        companyDescriptionTextView.text = aboutCompanyPlaceholder
    ...
    @IBAction func changeImage(_ sender: Any) {
        ...
        let libraryAction = UIAlertAction(title: "gallery".localized(), style: .default) { action in
    ...
    @IBAction func next(_ sender: Any) {
        ...
        if companyDescriptionTextView.text != aboutCompanyPlaceholder{
...
extension CreateCompanyTVC : UITextViewDelegate{
    func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
        if textView.text == aboutCompanyPlaceholder{
            textView.text = ""
    ...
    func textViewShouldEndEditing(_ textView: UITextView) -> Bool {
        if textView.text.isEmpty{
            textView.text = aboutCompanyPlaceholder
