        ...
        didSet{
            ...
            if let application = application{
                if let employee = application.employee{
                    employeeImageView.sd_setImage(with: employee.getImageUrl(), placeholderImage: Constants.placeholder, options: .continueInBackground, completed: nil)
                ...
                if application.status == ApplicationStatus.Accepted.rawValue {
                    self.acceptLabel.text = "acceptSendMessage".localized()
                } else {
                    self.acceptLabel.text = "acceptLabel".localized()
                }
                
                self.skipLabel.text = "skipLabel".localized()
                ...
                skipLabel.text = "skipLabel".localized()
                acceptLabel.text = "acceptLabel".localized()
            }
        }
    }
